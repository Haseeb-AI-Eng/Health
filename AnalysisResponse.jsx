      ...
      <div className="p-6 bg-white">
        ...
        {ai_commentary && (
          <motion.div
            ...
            className="mb-6 bg-gradient-to-r from-blue-50 to-indigo-50 border-l-4 border-blue-500 rounded-lg p-4"
          >
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-xs font-semibold text-blue-600 uppercase mb-1">Clinical Summary</p>
        ...
        {/* AI Analysis */}
        {explanation && (
          <Section title="AI Clinical Analysis" icon={FiInfo} iconColor="bg-blue-500" delay={0.8}>
        ...
        >
          {onDownloadPDF && (
            <button
              ...
              className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white rounded-xl font-medium shadow-md hover:shadow-lg transition-all"
            >
              <FiDownload size={18} />
              Download PDF Report
            </button>
