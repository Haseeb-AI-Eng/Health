...
const DoctorLogin = ({ onLoginSuccess }) => {
 ...
 <p className="text-xs font-semibold text-purple-800 mb-2">Demo Credentials:</p>
 <p className="text-xs text-purple-700">Name: <span className="font-mono bg-white px-2 py-0.5 rounded border border-purple-300">aliejaz</span></p>
 <p className="text-xs text-purple-700">Password: <span className="font-mono bg-white px-2 py-0.5 rounded border border-purple-300">1122334455</span></p>
 </div>
