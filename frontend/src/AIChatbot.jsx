            ...
            >
              ...
              >
                ...
                {message.possible_causes && message.possible_causes.length > 0 && (
                  <div className="mt-4 bg-gradient-to-br from-purple-50 to-indigo-50 border border-purple-200 rounded-xl p-3">
                ...
                {message.body_explanation && (
                  <div className="mt-4 bg-gradient-to-br from-blue-50 to-cyan-50 border border-blue-200 rounded-xl p-3">
                    <div className="flex items-center gap-2 mb-2">
                      <FiHeart className="text-blue-600" size={18} />
                      <p className="text-sm font-bold text-blue-800 uppercase">What's Happening in Your Body</p>
                    </div>
                ...
                {message.recommendations && message.recommendations.length > 0 && (
                  <div className="mt-4 bg-gradient-to-br from-emerald-50 to-green-50 border border-emerald-200 rounded-xl p-3">
                    <div className="flex items-center gap-2 mb-2">
                ...
                {message.red_flags && message.red_flags.length > 0 && (
                  <div className="mt-4 bg-gradient-to-br from-red-50 to-rose-50 border border-red-200 rounded-xl p-3">
                    <div className="flex items-center gap-2 mb-2">
                ...
                {/* Next Steps Section */}
                {message.next_steps && (
                  <div className="mt-4 bg-gradient-to-br from-amber-50 to-orange-50 border border-amber-200 rounded-xl p-3">
                    <div className="flex items-center gap-2 mb-2">
                ...
                <p className={`text-xs mt-3 ${message.role === 'user' ? 'text-blue-100' : 'text-gray-400'}`}>
        ...
        <div className="p-4 bg-white border-t border-gray-200">
          <div className="flex gap-3">
            ...
            <button
              ...
              className="px-6 py-3 bg-blue-600 text-white rounded-xl font-semibold hover:bg-blue-700 transition-colors disabled:bg-blue-400 flex items-center gap-2"
            >
              <FiSend size={18} />
              Send
            </button>
