  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <motion.div
        ...
        className="bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 rounded-3xl shadow-2xl w-full max-w-6xl overflow-hidden border-2 border-purple-200 max-h-[90vh] flex flex-col"
      >
        {/* Header */}
        <div className="bg-gradient-to-r from-purple-600 via-pink-600 to-rose-600 p-6 flex justify-between items-center shrink-0">
          <div>
        ...
        <div className="flex-1 flex overflow-hidden">
          {/* Graph Canvas */}
          <div
            className="flex-1 relative bg-gradient-to-br from-white via-purple-50 to-blue-50 overflow-hidden"
